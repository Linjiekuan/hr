...
<script type="text/javascript" src="/SSM-Project/js/jquery-1.8.0.min.js"></script><!-- <别的js要引用jquery.js时候，需要提前引入！> -->
<body>
	...
	<form  method="post" name="form1" id="form_login" action="login">
		...
		<div class="form-group">
			...
			<div><h1> <label class="yanzhengma" id="yanzhengma" onclick="yanzhengma()" >  </label></h1></div>
		</div>
...
<!-- <div class="hovertree_form_footer"></div>	 -->
		...
		<input type="text" name="city" id="city" placeholder="输入城市名字" autocomplete="off">
		<button type="submit" class="wsButton" id="wsButton">点击查询天气</button>
